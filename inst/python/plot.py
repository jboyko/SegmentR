...
import cv2  # Used in annotate and plot_detections functions
import numpy as np  # Extensively used throughout the script
import matplotlib.pyplot as plt  # Used in plot_detections function
import plotly.express as px  # Used in plot_detections_plotly function
import plotly.graph_objects as go  # Used in plot_detections_plotly function
