...
def segment(
    ...
    """
    device = "cuda" if torch.cuda.is_available() else "cpu"
    segmenter_id = segmenter_id if segmenter_id is not None else "Zigeng/SlimSAM-uniform-77"
...
def grounded_segmentation(
    ...
    print('begin the detection!')
    detections = detect(image, labels, threshold, detector_id)
    print('detection complete.')
    print('begin the segment!')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--detector_id", type=str, default=None, help="ID of the detector model")
    parser.add_argument("--segmenter_id", type=str, default=None, help="ID of the segmenter model")
...
# image_url = "../../../floral-vision/images/21838.jpg"
...
# plot_detections(image_array, detections, "flowers.png")
