...
import cv2  # Used in mask_to_polygon function
import numpy as np  # Used extensively throughout the script
from PIL import Image  # Used in load_image function
import requests  # Used in load_image function
import torch  # Used in refine_masks function
