...
One particularly interesting test case of segcolr is the ability to remove "parts" of an animal. For example, removing the fins of a fish so that you can access only the color. 
